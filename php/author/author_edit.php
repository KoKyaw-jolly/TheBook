...
<body>
    ...
    <section class="home-section">
        <div class="main_content_wrapper">
            <div class="main_content_header">Edit Author</div>
            <div class="main_content">
                ...
                <div style="margin-bottom: 20px;">
                    <a href="author_list.php" class="back-link"><i class="fa fa-reply" aria-hidden="true"></i>  Back to Author List</a>
                </div>
                <div>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                        <div class="form-group">
                            <label for="author_ID">Author ID</label>
                            <input type="text" class="form-control" id="author_ID" name="author_ID" placeholder="Author ID" value="<?php echo $row['author_ID'] ?>" readonly>
                        </div>
                        <div class="form-group">
