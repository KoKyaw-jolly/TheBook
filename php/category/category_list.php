...
<body>
    ...
    <section class="home-section">
        <div class="main_content_wrapper">
            <div class="main_content_header">Category List</div>
            <div class="main_content">
                <button type="button" class="btn btn_create_new">
                    <a href="category_new.php">
                        <i class="fa fa-plus-circle" aria-hidden="true"></i> Create New Category
                    </a>
                </button>
                <?php
                ...
                ?>
                <table id="category_list_table" class="table list display" style="width:100%">
                    <thead>
                        <tr>
                        <th scope="col">No</th>
                    ...
                    <tbody>
                        <?php $i=1; while($row=mysqli_fetch_assoc($result)) {?>
                            <tr>
                                ...
                                <th scope="row">
                                    <a href="category_edit.php?category_ID=<?php echo $row['category_ID'] ?>" class="edit">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    <a href="category_delete.php?category_ID=<?php echo $row['category_ID'] ?>" class="del" onClick="return confirm('Are You Sure?')">
